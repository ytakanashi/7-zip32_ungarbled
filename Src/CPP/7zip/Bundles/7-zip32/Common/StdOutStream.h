...
public:
	...
	void SetStdOutMode(BOOL bStdOut){ m_bStdOut = bStdOut; }	// í«â¡(19000002)

	CProgressDialog* GetProgressDialog() { return m_pDlgProgress; }
//	void CloseProgressDialog() { ::PostMessage(m_pDlgProgress->m_hWnd, WM_CLOSE, 0, 1); }	// çÌèú(19000002)
	/* í«â¡(19000002)Ç±Ç±Ç©ÇÁ */
	void CloseProgressDialog() {
		if (m_bStdOut)
			::FlushFileBuffers(GetStdHandle(STD_OUTPUT_HANDLE));
		::PostMessage(m_pDlgProgress->m_hWnd, WM_CLOSE, 0, 1);
	}
	/* í«â¡(19000002)Ç±Ç±Ç‹Ç≈ */
	...
	BOOL GetStdOutMode(){ return m_bStdOut; }	// í«â¡(19000002)

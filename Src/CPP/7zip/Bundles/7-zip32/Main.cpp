...
#include "../../UI/Common/Bench.h"						// パス変更
...
#include "../../Common/RegisterCodec.h"					// パス変更
...
)
{
  ...
  */
  ...
  {
    CStdOutStream &so = (g_StdStream ? *g_StdStream : g_StdOut);
    hresultMain = BenchCon(Z7_EXTERNAL_CODECS_VARS_L

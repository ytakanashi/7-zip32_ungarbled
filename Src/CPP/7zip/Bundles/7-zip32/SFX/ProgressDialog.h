...
#include "../../../../Windows/Synchronization.h"		// パス変更
#include "../../../../Windows/Thread.h"				// パス変更

#include "../../../../Windows/Control/Dialog.h"		// パス変更
#include "../../../../Windows/Control/ProgressBar.h"	// パス変更

#include "../resource.h"					// パス変更
...
public:
  ...
  {
    _title = title;
    INT_PTR res = CModalDialog::Create(IDD_DIALOG_PROGRESS, wndParent);	// 変更
    thread.Wait_Close();	// 変更
    return res;
  }

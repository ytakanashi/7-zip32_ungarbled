...
●ビルド方法(開発者向け)
 ...
 2.「7-zip32.dll」「7-zip64.dll」であれば、
    1.「7z922/CPP/7zip/Bundles」に「7-zip32」ディレクトリを作成します。
    2.「7z920001.zip」(http://akky.xrea.jp/)をダウンロード、解凍します。
    3.「src.7z」を解凍し、作成した「7-zip32」ディレクトリにファイルをコピーします。
 3.本ライブラリの「Src.7z」を解凍し、ファイルを「7z922」に上書きします。
 4.「7-zip32.dll」「7-zip64.dll」は
     「7z922/CPP/7zip/Bundles/7-zip32/7-zip32.sln」
   「7z.dll」は
     「7z922/CPP/7zip/Bundles/Format7zF/Format7z.sln」
   を開きます。
